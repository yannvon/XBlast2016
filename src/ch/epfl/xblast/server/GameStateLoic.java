...
public final class GameStateLoic {
     ...
     */
    public GameStateLoic(int ticks, Board board, List<Player> players,
     ...
     *             negative.
     */
    public GameStateLoic(Board board, List<Player> players) {
    ...
    public GameStateLoic next(Map<PlayerID, Optional<Direction>> speedChangeEvents,
        ...
        bombs1.addAll(newlyDroppedBombs(players, bombDrpEvents, bombs)); //sort player list!!
        ...
        for(Bomb b: bombs){
            ...
            if (!newFuse.isEmpty() || blasts1.contains(b.position())){ 
