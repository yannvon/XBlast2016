...
public final class GameStateYann {
     ...
     */
    public GameStateYann(int ticks, Board board, List<Player> players,
     ...
     */
    public GameStateYann(Board board, List<Player> players) {
     ...
     */
    public GameStateYann next(Map<PlayerID, Optional<Direction>> speedChangeEvents,
        ...
        return new GameStateYann(ticks + 1, board1, players1, bombs1, explosions1, blasts1);
    }
